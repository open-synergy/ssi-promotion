...
- **Data:** A posted `account.move.line` receivable journal item to allocate — reconcilable
  account, not yet fully reconciled, positive residual, in the company currency — if a row
  is to be added on the **Allocation** tab.
...
5. Optional: open the **Allocation** tab to list receivable journal items this usage's own
   credit note should be reconciled against once approved. Add a row and fill in:
   - **Source** _(required)_: **Voucher User** or **Referrer** — which of this usage's own
     two credit notes is consumed against this row. Defaults to **Voucher User**.
